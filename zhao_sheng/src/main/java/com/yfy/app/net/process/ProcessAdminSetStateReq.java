 ...
 */
@Root(name = TagFinal.PROCESS_ADMIN_SET_STATE, strict = false)
@Namespace(reference = TagFinal.NAMESPACE)
@Order(elements = {Base.session_key,Base.id,Base.state,Base.content,Base.image,Base.voice,"star"})
public class ProcessAdminSetStateReq {
