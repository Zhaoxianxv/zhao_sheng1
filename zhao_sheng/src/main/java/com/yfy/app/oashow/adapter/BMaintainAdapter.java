...
import com.yfy.app.oashow.BMaintainDetailActivity;
...
public class BMaintainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<BMaintian> dataList;
    private Context mContext;
    private String user_name="状态：";
    private String type_star="已评价";
    private String type="完成维修";
    public void
    setDataList(List<BMaintian> dataList) {
...
//        getRandomHeights(dataList);
    ...
    public BMaintainAdapter(Context mContext, List<BMaintian> dataList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RecyclerViewHolder) {
            ...
            if (reHolder.bean.getDealstate().equals(type)){
                reHolder.state.setTextColor(Color.rgb(155,155,155));
            }else{
                reHolder.state.setTextColor(Color.rgb(255,102,51));
            }

//            reHolder.star.setText("");
//            if (reHolder.bean.getStar().equals("")){
//                reHolder.star.setText(reHolder.bean.getStar());
//            }else{
//                reHolder.star.setText(type_star);
//            }
    ...
    private class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        RecyclerViewHolder(View itemView) {
            ...
            name= (TextView) itemView.findViewById(R.id.maintain_content);
            state= (TextView) itemView.findViewById(R.id.maintain_new_state);
//            star=  itemView.findViewById(R.id.maintain_item_star);
            layout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(mContext, BMaintainDetailActivity.class);
                    Bundle b=new Bundle();
