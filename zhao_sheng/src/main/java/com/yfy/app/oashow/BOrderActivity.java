...
import com.yfy.app.oashow.adapter.BOrderAdapter;
...
public class BOrderActivity extends BaseActivity implements Callback<ResEnv> {

    private static final String TAG = BOrderActivity.class.getSimpleName();
...
//        xlist.setLayoutManager(new GridLayoutManager(this, 1));
        ...
        adapter=new BOrderAdapter(mActivity);
    ...
    public void refresh(boolean is,String loadType){
        ...
        BOrderMainReq request = new BOrderMainReq();
        //获取参数
        request.setPage(page);

        reqBody.bOrderMainReq = request;
        reqEnvelop.body = reqBody;
        Call<ResEnv> call = RetrofitGenerator.getWeatherInterfaceApi().order_get_b_main(reqEnvelop);
        call.enqueue(this);
    ...
    public void onResponse(Call<ResEnv> call, Response<ResEnv> response) {
        ...
        if (respEnvelope != null) {
            ...
            if (b.bOrderMainRes !=null){
                String result=b.bOrderMainRes.result;
                ...
                if (res.getAdmin().size()!=TagFinal.TEN_FIVE){
