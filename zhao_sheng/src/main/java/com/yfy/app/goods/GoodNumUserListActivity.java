...
public class GoodNumUserListActivity extends BaseActivity implements Callback<ResEnv> {

    private static final String TAG = GoodNumUserListActivity.class.getSimpleName();
    private int pager=0;
...
//        xlist.setLayoutManager(new GridLayoutManager(this, 1));
    ...
    public void refresh(boolean is,String loadType){
        ...
        GoodNumUserListReq req = new GoodNumUserListReq();
        //获取参数
        req.setPage(pager);

        reqBody.goodNumUserListReq= req;
        reqEnvelop.body = reqBody;
        Call<ResEnv> call = RetrofitGenerator.getWeatherInterfaceApi().goods_num_user_list(reqEnvelop);
        call.enqueue(this);
    ...
    public void onResponse(Call<ResEnv> call, Response<ResEnv> response) {
        ...
        if (respEnvelope != null) {
            ...
            if (b.goodNumUserListRes!=null) {
                String result = b.goodNumUserListRes.result;
