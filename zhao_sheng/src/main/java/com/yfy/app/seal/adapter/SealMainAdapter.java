 ...
 */
public class SealMainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SealMainAdapter(Activity mContext){
...
//        holder.itemView.setLongClickable(true);
        if (holder instanceof RecyclerViewHolder) {
            ...
            reHolder.name.setText(StringUtils.getTextJoint("%1$s-%2$s", reHolder.bean.getSignetname(),reHolder.bean.getTypename()));
            ...
            GlideTools.chanCircle(mContext, reHolder.bean.getApprovalheadpic(), reHolder.head,R.drawable.head_user );
        ...
        RecyclerViewHolder(View itemView) {
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    data.putExtra(TagFinal.TYPE_TAG,"user");
