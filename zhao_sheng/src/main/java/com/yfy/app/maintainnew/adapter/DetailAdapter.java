...
//        getRandomHeights(dataList);
    ...
    public DetailAdapter(Activity mContext, List<FlowBean> dataList,MainBean bean,boolean end) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RecyclerViewHolder) {
            ...
            GlideTools.chanCircle(mContext,reHolder.bean.getAvatar(),reHolder.head,R.drawable.head_user);
            ...
            if (end){//user
                switch (bean.getDealstate()){
                    ...
                    case "拒绝维修":
                        ...
                        break;
                    case "申请维修":
                        if (Base.user.getName().equals(bean.getUser_name())){
            ...
            topHolder.top_tell.setText(bean.getMobile());
