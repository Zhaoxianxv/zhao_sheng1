...
public class ProLayerThreeData implements Parcelable {
    ...
    private List<ProLayerThreeData> recordlinkvalues;
    ...
    public List<ProLayerThreeData> getRecordlinkvalues() {
        return recordlinkvalues;
    }

    public void setRecordlinkvalues(List<ProLayerThreeData> recordlinkvalues) {
    ...
    protected ProLayerThreeData(Parcel in) {
        ...
        this.recordlinkvalues = in.createTypedArrayList(ProLayerThreeData.CREATOR);
        this.recordvaluearray = in.createTypedArrayList(ProLinkListBean.CREATOR);
    }

    public static final Creator<ProLayerThreeData> CREATOR = new Creator<ProLayerThreeData>() {
        @Override
        public ProLayerThreeData createFromParcel(Parcel source) {
            return new ProLayerThreeData(source);
        }

        @Override
        public ProLayerThreeData[] newArray(int size) {
            return new ProLayerThreeData[size];
        }
    };
}
