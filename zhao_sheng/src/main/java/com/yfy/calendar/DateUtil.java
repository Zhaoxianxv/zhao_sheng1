...
public class DateUtil {
	...
	public static Date getDateFromString(int year, int month) {
		...
		try {
			...
			Logger.e(TagFinal.ZXX, "e.getMessa");
		}
		return date;
	}
	...
	public static boolean isNextMonth(CustomDate date) {
		...
		return date.year > DateUtil.getYear() || (date.year == DateUtil.getYear()&&date.month> DateUtil.getMonth());
	}

	public static boolean isSameMonth(CustomDate date, CustomDate showDate) {
		if (date == null) {
			return false;
		}
		return (date.year == showDate.year && date.month == showDate.month);
	}
}
